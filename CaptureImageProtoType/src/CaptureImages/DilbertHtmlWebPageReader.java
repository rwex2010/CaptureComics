...
public class DilbertHtmlWebPageReader extends HtmlWebPageReader {
    ...
    public String strSuccessfullyReadImageWebPage = "Not Yet";
    ...
    public DilbertHtmlWebPageReader(DisplayDebugMessage dbgDisplayObject) throws Exception {
	...
	try {
	    ...
	    strSuccessfullyReadImageWebPage = "GotIt";
	} catch (IOException e) {
	...
	DilbertWebPageHtmlParser htmlParserCallBack = new DilbertWebPageHtmlParser();
    ...
    public String getStrSuccessfullyReadImageWebPage() {
        return strSuccessfullyReadImageWebPage;
    }
